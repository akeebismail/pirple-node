...
// Perform the check, send the original check data and the outcome of the check process to the
workers.performCheck = function (checkData) {
  ...
  //Mark that the outcome has not been sent yet
    ...
    // Parse the hostname and path out of the checkData
    ...
    var req = _moduleToUse.request(requestDetails, function (res) {
        // Grab the status pf the sent request
    ...
    // Bind to the error event so it doesn't get down
